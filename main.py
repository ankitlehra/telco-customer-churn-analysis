...
connection = mysql.connector.connect(
    ...
    user="root",
    password="",
    database="telco_churn"  # Adjust the database name as per your MySQL Database
)
...
#  Tenure vs Monthly Charges by Churn (Scatter plot)
plt.figure(figsize=(10,6))
sns.scatterplot(x='tenure', y='MonthlyCharges', hue='Churn', data=df)
plt.title('Tenure vs Monthly Charges by Churn')
plt.show()

#  Churn by Payment Method (Count plot)
plt.figure(figsize=(10,6))
...
#  Churn Percentage by Gender (Pie Chart)
plt.figure(figsize=(8,6))
